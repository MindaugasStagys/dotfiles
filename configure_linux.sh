...
cd vim
./configure --prefix=$HOME --with-features=huge --enable-multibyte --enable-rubyinterp --enable-python3interp --enable-perlinterp --enable-luainterp --with-python3-config-dir=/usr/bin/python3/python3-config
make
make install
cd ..
